...
<div style="position: relative; left: 50%; float: left;">
    <!-- Download links -->
    <a href="${pageContext.request.contextPath}/resources/downloads/politestare-win.zip" style="position: relative; left: -50%;">
        <img style="position: relative;" src="${pageContext.request.contextPath}/resources/images/windows.png">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#logoutBtn').click(function(e) {
            ...
            e.preventDefault();
			var email = $("#email").val();
            $.post("api/logout", {'email': email}, function(data) {
