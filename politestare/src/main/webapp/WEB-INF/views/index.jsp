...
================================================== -->
  ...
  <div id="home">
              ...
              <video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0" poster="${pageContext.request.contextPath}/resources/images/1.jpg">
                
                <source src="${pageContext.request.contextPath}/resources/videos/video.webm" type="video/webm">
                
                <source src="${pageContext.request.contextPath}/resources/videos/video.mp4" type="video/mp4">
                
                <source src="${pageContext.request.contextPath}/resources/videos/video.ogg" type="video/ogg">
        ...
        <div id="main" class="main">
          <figure>
            <div class="drawings mac">
              <img class="illustration" src="${pageContext.request.contextPath}/resources/images/celebrate.jpg" alt="iMac Illustration" />
    ...
    <div class="container">
        ...
        <div class="flipWrapper">
          <div class="card">
            <div class="face front">
              <img src="${pageContext.request.contextPath}/resources/images/multitask.jpg" alt="" />
            </div>
            <div class="face back">
              <p>
                <small>
      ...
      <div class="one-third column" data-scrollreveal="enter bottom and move 50px over 1s">
        ...
        <div class="flipWrapper">
          <div class="card">
            <div class="face front">
              <img src="${pageContext.request.contextPath}/resources/images/oneclick.jpg" alt="" />
            </div>
            <div class="face back">
              <p>
                <small>
      ...
      <div class="one-third column" data-scrollreveal="enter right and move 50px over 1s">
        ...
        <div class="flipWrapper">
          <div class="card">
            <div class="face front">
              <img src="${pageContext.request.contextPath}/resources/images/savemoney.jpg" alt="" />
            </div>
            <div class="face back">
              <p>
                <small>
    ...
    <div class="container">
      ...
      <div class="one-third column" data-scrollreveal="enter left and move 100px over 1s">
        <div class="services-offer featured">
          <img id="price" style="width: 100%; height: 480px;" src="${pageContext.request.contextPath}/resources/images/price.png"/>
        </div>
      </div>
